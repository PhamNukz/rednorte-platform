...
router.post('/', verifyToken, requireRole('paciente', 'medico', 'admin'), ctrl.registrar);
router.get('/', verifyToken, ctrl.listar);
router.get('/resumen', verifyToken, requireRole('medico', 'admin'), ctrl.resumen);
router.get('/siguiente-elegible', verifyToken, requireRole('medico', 'admin'), ctrl.siguienteElegible);
router.get('/:id', verifyToken, ctrl.obtener);
router.patch('/:id/estado', verifyToken, requireRole('paciente', 'medico', 'admin'), ctrl.actualizarEstado);
